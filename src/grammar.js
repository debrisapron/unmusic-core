...
var grammar = {
    ...
    {"name": "NOTE", "symbols": ["PITCH_CLASS"], "postprocess": (data) => ['NOTE', { kind: 'PITCH_CLASS', value: data[0] }]},
    {"name": "NOTE", "symbols": [{"literal":"M"}, "INTEGER"], "postprocess": (data) => ['NOTE', { kind: 'MIDI',        value: data[1] }]},
    {"name": "NOTE", "symbols": ["INTEGER"], "postprocess": (data) => ['NOTE', { kind: 'RELATIVE',    value: data[0] }]},
