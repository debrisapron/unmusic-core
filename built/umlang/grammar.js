...
(function () {
    ...
    var grammar = {
        ...
        ParserRules: [
            ...
            { "name": "SEQUENCE", "symbols": ["SEQUENCE", "_", "TOKEN"], "postprocess": function (data) { return data[0].concat(data[2]); } },
            ...
            { "name": "NOTE", "symbols": ["PITCH_CLASS"], "postprocess": function (data) { return ['NOTE', { type: 'PITCH_CLASS', value: data[0] }]; } },
            { "name": "NOTE", "symbols": [{ "literal": "M" }, "INTEGER"], "postprocess": function (data) { return ['NOTE', { type: 'MIDI', value: data[1] }]; } },
            { "name": "NOTE", "symbols": ["INTEGER"], "postprocess": function (data) { return ['NOTE', { type: 'RELATIVE', value: data[0] }]; } },
            { "name": "PITCH_CLASS$ebnf$1", "symbols": [/[b♭#♯]/], "postprocess": id },
            { "name": "PITCH_CLASS$ebnf$1", "symbols": [], "postprocess": function (d) { return null; } },
            { "name": "PITCH_CLASS", "symbols": [/[A-G]/, "PITCH_CLASS$ebnf$1"], "postprocess": function (data) { return str(data); } },
            { "name": "TRIG", "symbols": ["IDENTIFIER"], "postprocess": function (data) { return ['TRIG', data[0]]; } },
            ...
            { "name": "REST", "symbols": ["REST$ebnf$1"], "postprocess": function (data) { return ['REST', data[0].length]; } },
            ...
            { "name": "OCTAVE_CHANGE", "symbols": ["OCTAVE_CHANGE$ebnf$1"], "postprocess": function (data) { return ['OCTAVE_CHANGE', parseInt('-' + data[0].length)]; } },
            ...
            { "name": "OCTAVE_CHANGE", "symbols": ["OCTAVE_CHANGE$ebnf$2"], "postprocess": function (data) { return ['OCTAVE_CHANGE', parseInt(data[0].length)]; } },
            { "name": "SETTING", "symbols": ["IDENTIFIER", { "literal": "=" }, "VALUE"], "postprocess": function (data) { return ['SETTING', { param: data[0], value: data[2] }]; } },
            { "name": "SETTING", "symbols": ["NOTE_VALUE"], "postprocess": function (data) { return ['SETTING', { param: 'duration', value: data[0] }]; } },
            { "name": "VALUE", "symbols": ["NOTE_VALUE"], "postprocess": id },
            { "name": "VALUE", "symbols": ["STRING"], "postprocess": function (data) { return !isNaN(data[0]) ? parseFloat(data[0]) : data[0]; } },
            { "name": "NOTE_VALUE", "symbols": ["INTEGER", { "literal": "/" }, "INTEGER"], "postprocess": function (data) { return data[0] / data[2]; } },
            { "name": "NOTE_VALUE", "symbols": [{ "literal": "/" }, "INTEGER"], "postprocess": function (data) { return 1 / data[1]; } },
            ...
            { "name": "CHORD_GROUP", "symbols": [{ "literal": "{" }, "CHORD_GROUP$ebnf$1", "CHORD_TOKENS", "CHORD_GROUP$ebnf$2", { "literal": "}" }], "postprocess": function (data) { return ['CHORD_GROUP', data[2]]; } },
            { "name": "CHORD_TOKENS", "symbols": ["CHORD_TOKEN"], "postprocess": id },
            { "name": "CHORD_TOKENS", "symbols": ["CHORD_TOKENS", "_", "CHORD_TOKEN"], "postprocess": function (data) { return data[0].concat(data[2]); } },
            ...
            { "name": "IDENTIFIER", "symbols": ["LCASE_LETTER", "IDENTIFIER$ebnf$1"], "postprocess": function (data) { return str(data[0].concat(data[1])); } },
            ...
            { "name": "STRING", "symbols": ["STRING$ebnf$1"], "postprocess": function (data) { return str(data[0]); } },
            ...
            { "name": "FLOAT", "symbols": ["INTEGER", { "literal": "." }, "FLOAT$ebnf$1"], "postprocess": function (data) { return parseFloat(str(data)); } },
            ...
            { "name": "INTEGER", "symbols": ["INTEGER$ebnf$1", "INTEGER$ebnf$2"], "postprocess": function (data) { return parseInt((data[0] === '-' ? '-' : '') + str(data[1])); } },
